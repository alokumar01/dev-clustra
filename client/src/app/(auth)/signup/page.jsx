...
export default function SignupPage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      toast.error(
        submitError.response?.data?.message || "Signup failed Client"
      )
    } finally {
      setLoading(false);
    }
      ...
      highlights={[
        {
          ...
          description: "Helpful copy and cleaner field structure make the first interaction easier to understand.",
        },
        {
          icon: ShieldPlus,
          title: "Safer first impression",
          description: "Trust signals and clearer spacing make the experience feel more polished and credible.",
        },
        {
          icon: Rocket,
          title: "Ready to scale",
          description: "A reusable auth shell gives login and signup a shared visual language you can extend later.",
        },
      ]}
        ...
        <FieldSet>
          <FieldGroup className="gap-4">
            <Field>
              ...
              />
              <FieldDescription>
                Pick a unique handle people will recognize in your workspace.
              </FieldDescription>
            </Field>
            ...
            <Field>
              ...
              />
              <FieldDescription>
                Use at least 8 characters so your account starts with a solid baseline.
              </FieldDescription>
            </Field>
          </FieldGroup>
        </FieldSet>
